'''
Template scipt for new sound effects for the Pdialyte Effects Pedal
If you are following my protocol you only need to modify the designated (by block comment) lines
'''
...
def main():
    ...
    '''
    MODIFY THESE LINES
    You may Implement any number of controls
    ...
    control3 will be sent to Pd in format '2 control_value' use route object accordingly
    control4 will be sent to Pd in format '3 control_value' use route object accordingly
